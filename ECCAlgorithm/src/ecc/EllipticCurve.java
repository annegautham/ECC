...
/**
 * This class represents Elliptic Curve in Galois Field determined by p. The equation will
 * be in form  y^2 = x^3 + ax + b (mod p), for which a and b satisfy
 * 4a^3 + 27b^2 != 0 (mod p) - there are actually many possible choices, but I read https://malware.news/t/everyone-loves-curves-but-which-elliptic-curve-is-the-most-popular/17657
...
public class EllipticCurve {
    ...
    // Optional attribute, the base point g - does not require!
    ...
    // We provide some standard curves stolen from
    ...
    /**
     * Warning: p = 1 (mod 4), cannot be used throughout the algorithm! Something about not being able to solve quadriatics here!!
     */
    ...
    /**
     * Subtract two points, according to this equation: p1 - p2 = p1 + (-p2), where -p2 is the reflection of p2 with respect to the x-axis.
     */
